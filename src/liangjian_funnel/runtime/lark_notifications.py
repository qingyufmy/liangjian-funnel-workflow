...
_DISPLAY_LABELS = {
    ...
    **_ACTION_LABELS,
    ...
    "FILLED": "已模拟成交",
    "CANCELLED": "委托已终止",
    "ENTRY_NO_NEXT_TRADING_MINUTE": "当日已无下一可交易分钟，仅记录观察",
    "ENTRY_NEXT_MINUTE_AFTER_PLAN_EXPIRY": "下一分钟已超过计划有效期",
    "ENTRY_PRICE_CONTRACT_INVALID": "入场价格契约不成立",
    "ENTRY_PLAN_EXPIRY_INVALID": "计划有效期无法核实",
    "INVALIDATED": "计划已失效",
    "CLOSE": "收盘价",
    "OPEN": "开盘价",
    "VOLUME": "成交量",
