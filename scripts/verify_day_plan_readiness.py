...
def main():
    ...
    module_checks={}
    for name in ('pipeline.deterministic','pipeline.research','pipeline.model_client','runtime.strategies','runtime.monitor','runtime.entry_contract','runtime.simulation','runtime.indicator_history','runtime.lark_notifications','runtime.auction_base','runtime.auction_refresh','data.eastmoney_hot','data.mootdx','review.context','review.daily','review.verification','workflow'):
